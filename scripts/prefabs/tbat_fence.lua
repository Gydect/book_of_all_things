...
local function MakeWall(name, anims)
...
local function MakeWallPlacer(placer, anims)
    return MakePlacer(
        placer,
        anims.wide,
        anims.wide,
...
return MakeWall("tbat_cozy_rosebush_fence", { wide = "tbat_cozy_rosebush_fence" }),
    MakeInvItem("tbat_cozy_rosebush_fence_item", "tbat_cozy_rosebush_fence", "tbat_cozy_rosebush_fence"),
    MakeWallPlacer("tbat_cozy_rosebush_fence_item_placer", { wide = "tbat_cozy_rosebush_fence" }),

    MakeWall("tbat_rose_trellis_fence", { wide = "tbat_rose_trellis_fence" }),
    MakeInvItem("tbat_rose_trellis_fence_item", "tbat_rose_trellis_fence", "tbat_rose_trellis_fence"),
    MakeWallPlacer("tbat_rose_trellis_fence_item_placer", { wide = "tbat_rose_trellis_fence" })
